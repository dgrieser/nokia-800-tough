...
Utils.extend(AlarmEdit.prototype, {
  ...
  soundRadioChecked: function(soundSelect) {
    var soundLastSelect = document.querySelector('.newSoundChecked');
    var soundSelectRadio = soundSelect.querySelector('.clsSoundBackIcon');
    soundLastSelect.classList.toggle('newSoundChecked', false);
    soundLastSelect.setAttribute('data-icon', 'radio-off');
    soundSelectRadio.classList.toggle('newSoundChecked', true);
    soundSelectRadio.setAttribute('data-icon', 'radio-on');
  },

  soundLabelSet: function(soundLabelData) {
    var soundLabel = document.getElementById('new-alarm-sound-label');
  ...
  save: function aev_save(callback) {
    ...
    if (alarm.sound !== '0') {
      SettingsApp.setValue('alarm.sound', alarm.sound);
    }
